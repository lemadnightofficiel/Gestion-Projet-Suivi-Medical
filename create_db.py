...
cursor.execute("CREATE TABLE users (userID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, name VARCHAR(32), lastname VARCHAR(32), sex BOOL NOT NULL, birthday DATE NOT NULL, username VARCHAR(64) UNIQUE NOT NULL, password VARCHAR(64))") # send command to the database
